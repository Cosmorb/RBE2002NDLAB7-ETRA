...
bool HC_SR04::getDistance(float& distance)
{
    ...
    float pulseWidthToDistance = (echoLength / 2) * 0.0343; //To convert, take the pulse width divide by 2, then multiply by speed of sound (cm/sec)
    distance = pulseWidthToDistance; 
